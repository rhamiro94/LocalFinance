...
# Define una función para conectar a la base de datos Heroku PostgreSQL
def connect_to_database():
    DATABASE_URL = "postgres://uekbbe1ueq4jbf:pd5c6fcbd0dff5795c0a84dd096befbf7a2ecd7fed67284fd6182b9420ad71cd8@cb5ajfjosdpmil.cluster-czrs8kj4isg7.us-east-1.rds.amazonaws.com:5432/db1k1aittugu7k"
    conn = psycopg2.connect(DATABASE_URL, sslmode='require')  # Conectar a la base de datos
    return conn
